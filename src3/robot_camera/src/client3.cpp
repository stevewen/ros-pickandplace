...
int main(int argc, char **argv)
{
  ...
  if (client.call(srv))
  {
      ...
      for (int i = 0; i < num; i++)
      {
        ...
        float  cxx = 0.65;  float  cyy = -0.1;  float  czz = 1.35;

        if(srv.response.Class[i].compare("box") == 0)
        {
        res_name[0] = srv.response.Class[i];
        res_x[0] =-srv.response.center_y[i] + cxx;
        res_y[0] =-srv.response.center_x[i] + cyy;
        ...
        res_x[1] =-srv.response.center_y[i] + cxx;
        res_y[1] =-srv.response.center_x[i] + cyy;
        ...
        res_x[2] =-srv.response.center_y[i] + cxx;
        res_y[2] =-srv.response.center_x[i] + cyy;
        ...
        res_x[3] =-srv.response.center_y[i] + cxx;
        res_y[3] =-srv.response.center_x[i] + cyy;
        ...
        res_x[4] =-srv.response.center_y[i] + cxx;
        res_y[4] =-srv.response.center_x[i] + cyy;
        ...
        res_x[5] =-srv.response.center_y[i] + cxx;
        res_y[5] =-srv.response.center_x[i] + cyy;
...
// *****************************************************************************************
  ...
  if (inputString2 == "box")
  {
      objecty = object; tzz = 0.07; tyy=0.01; txx=0.0;
      meshy_pose = mesh_pose;
      graspx_left_gripper= "grasp1_left_gripper";
  }
  else if (inputString2 == "cube")
  {
      objecty = object4; tzz = 0.06; tyy=0.03; txx=0.03;
      meshy_pose = mesh4_pose;
      graspx_left_gripper= "grasp_left_gripper";
  }
  else if (inputString2 == "ball")
  {
      objecty = object2; tzz = 0.06; tyy=0.03; txx=0.03;
      meshy_pose = mesh2_pose;
      graspx_left_gripper= "grasp_left_gripper";
  }
  else if (inputString2 == "balloon")
  {
      objecty = object3; tzz = 0.07; tyy=0.03; txx=0.03;
      meshy_pose = mesh3_pose;
      graspx_left_gripper= "grasp1_left_gripper";
  }
  else if (inputString2 == "chipbox")
  {
      objecty = object1; tzz = 0.11; tyy=0.03; txx=0.03;
      meshy_pose = mesh1_pose;
      graspx_left_gripper= "grasp2_left_gripper";
  }
  else if(inputString2 == "teabox")
  {
      objecty = object5; tzz = 0.11; tyy=0.035; txx=0.03;
      meshy_pose = mesh5_pose;
      graspx_left_gripper= "grasp2_left_gripper";
  }
  else {
  ROS_ERROR("Your choose is NOT correct!");
...
// STEP 5: PLACE THE OBJECT
  ...
  // *****************************************************************************************
  // STEP 0: PLAN TO PRE TEACH HOME POSITION
